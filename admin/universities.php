        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					 <a href="add_uni.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Univiersity</a>
                        <!-- block -->
                                ...
                                <div class="span12">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<?php
												$x=1;
											$subject_query = mysqli_query($conn,"select * from univ")or die(mysqli_error());
